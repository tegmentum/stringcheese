...
//! ```
//!
//! The general cosine formula lies in `[-1, 1]`. StringCheese pins the input
...
//!   default to identity.
//!
//! [`from_generator_counts`]: stringcheese_ngram::GramVector::from_generator_counts
...
use stringcheese_ngram::GramVector;

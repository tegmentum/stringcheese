...
//! `comparand-corpus` [`FloatExpectation`] schema.
//!
//! This is the first crate in Comparand that exercises `FloatExpectation`
...
//!
//! [`FloatExpectation`]: comparand_corpus::FloatExpectation

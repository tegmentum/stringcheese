//! Jaro and Jaro-Winkler similarity for the Comparand toolkit.
//!
//! This crate is the third vertical slice of Comparand's algorithm coverage,
...
//! at the call site, in keeping with Comparand's rule that a representation

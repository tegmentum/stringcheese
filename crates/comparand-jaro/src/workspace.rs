...
//! [`Jaro::similarity_with_workspace`](crate::jaro::Jaro::similarity_with_workspace)
//! or
//! [`JaroWinkler::similarity_with_workspace`](crate::jaro_winkler::JaroWinkler::similarity_with_workspace).
//! The workspace implements [`Workspace`] from `comparand-core`, so

//! Verifies that depending on `stringcheese-hi` is enough to make the
//! Hindi pack visible through [`stringcheese_lang::registry`]. The
//! `register_language!` macro in `stringcheese-hi/src/lib.rs` is the
...
stringcheese_lang::pack_registry_smoke_test! {
    pack: stringcheese_hi::HINDI,
    pack_ty: stringcheese_hi::Hindi,
    code: "hi",
    name: "Hindi",
    smoke: |lang| {

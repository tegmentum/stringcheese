//! Verifies that depending on `stringcheese-pa` is enough to make the
//! Punjabi pack visible through [`stringcheese_lang::registry`]. The
//! `register_language!` macro in `stringcheese-pa/src/lib.rs` is the
...
stringcheese_lang::pack_registry_smoke_test! {
    pack: stringcheese_pa::PUNJABI,
    pack_ty: stringcheese_pa::Punjabi,
    code: "pa",
    name: "Punjabi",
    smoke: |lang| {

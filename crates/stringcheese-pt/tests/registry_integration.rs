//! Verifies that depending on `stringcheese-pt` is enough to make the
//! Portuguese pack visible through [`stringcheese_lang::registry`]. The
//! `register_language!` macro in `stringcheese-pt/src/lib.rs` is the
...
stringcheese_lang::pack_registry_smoke_test! {
    pack: stringcheese_pt::PORTUGUESE,
    pack_ty: stringcheese_pt::Portuguese,
    code: "pt",
    name: "Portuguese",
    smoke: |lang| {

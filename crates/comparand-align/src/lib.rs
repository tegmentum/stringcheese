...
//!
//! This crate is the v0.2 Comparand alignment subsystem. Unlike an edit-
...
//! # Score type
//!
//! Alignment scores are reported as [`Score<i32>`](comparand_core::Score).
...
//! [`MetricClass::Score`](comparand_core::MetricClass::Score) and deliberately
//! implement *neither* [`DistanceMetric`](comparand_core::DistanceMetric)
//! *nor* [`SimilarityMetric`](comparand_core::SimilarityMetric) — the

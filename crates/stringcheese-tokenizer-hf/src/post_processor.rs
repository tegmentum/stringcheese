...
//!   `TemplateProcessing` / `RobertaProcessing` pipeline covers every
//!   shipped Llama / Mistral / Qwen / XLM-RoBERTa shape today; add
//!   composition when a real checkpoint ships one.
//!

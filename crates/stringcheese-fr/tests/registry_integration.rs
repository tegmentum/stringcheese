//! Verifies that depending on `stringcheese-fr` is enough to make the
//! French pack visible through [`stringcheese_lang::registry`]. The
//! `register_language!` macro in `stringcheese-fr/src/lib.rs` is the
...
stringcheese_lang::pack_registry_smoke_test! {
    pack: stringcheese_fr::FRENCH,
    pack_ty: stringcheese_fr::French,
    code: "fr",
    name: "French",
    smoke: |lang| {

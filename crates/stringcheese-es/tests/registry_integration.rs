//! Verifies that depending on `stringcheese-es` is enough to make the
//! Spanish pack visible through [`stringcheese_lang::registry`]. The
//! `register_language!` macro in `stringcheese-es/src/lib.rs` is the
...
stringcheese_lang::pack_registry_smoke_test! {
    pack: stringcheese_es::SPANISH,
    pack_ty: stringcheese_es::Spanish,
    code: "es",
    name: "Spanish",
    smoke: |lang| {

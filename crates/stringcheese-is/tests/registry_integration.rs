...
//! Icelandic pack visible through [`stringcheese_lang::registry`]. The
//! `register_language!` macro in `stringcheese-is/src/lib.rs` is the
...
stringcheese_lang::pack_registry_smoke_test! {
    pack: stringcheese_is::ICELANDIC,
    pack_ty: stringcheese_is::Icelandic,
    code: "is",
    name: "Icelandic",
    smoke: |lang| {

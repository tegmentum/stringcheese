...
//! The explanation of the algorithm can be found in the parent module [crate::vendored::alphabets].

use super::RawOutcome;
use crate::vendored::core::{FilterList, LowercaseText};
use crate::vendored::utils::is_stop_char;
use crate::vendored::{Lang, Script};

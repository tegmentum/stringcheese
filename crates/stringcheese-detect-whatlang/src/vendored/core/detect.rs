...
use crate::vendored::core::{Info, Method, Options, Query};
use crate::vendored::scripts::{
    RawScriptInfo, Script,
    grouping::{MultiLangScript, ScriptLangGroup},
    raw_detect_script,
};
use crate::vendored::{alphabets, combined, trigrams};
...
mod tests {
    use super::*;
    use crate::vendored::core::FilterList;
    use crate::vendored::scripts::Script;

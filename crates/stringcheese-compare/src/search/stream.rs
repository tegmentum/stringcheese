...
//! # Motivation
//!
//! [`SinglePatternSearch`](crate::search::api::SinglePatternSearch) expects the
...
//! crate-wide policy documented on [`crate::search::api`]). For streaming, that
...
//!
//! [`SinglePatternSearch`]: crate::search::api::SinglePatternSearch

use alloc::collections::VecDeque;
use alloc::vec::Vec;

use crate::search::aho_corasick::AhoCorasick;
use crate::search::api::Match;
use crate::search::kmp::{Kmp, KmpPrepared};
use crate::search::rabin_karp::{RabinKarp, RabinKarpPrepared};
...
/// [`SinglePatternSearch`](crate::search::api::SinglePatternSearch) because not
...
///
/// [`SearchAlgorithm::Prepared`]: crate::search::api::SearchAlgorithm::Prepared
pub trait StreamingSearch {
    ...
    /// [`SearchAlgorithm`](crate::search::api::SearchAlgorithm) if some future
...
mod tests {
    use super::*;
    use crate::search::api::SearchAlgorithm;

...
//! scalar-delegation shape. A 128-bit-block Myers using SSE2's u64x2
//! integer arithmetic is the natural next step; it belongs in a
//! standalone commit alongside its differential tests.
...
pub unsafe fn distance(a: &[u8], b: &[u8]) -> u32 {
    ...
    // an SSE2 execution context — this is what makes the function

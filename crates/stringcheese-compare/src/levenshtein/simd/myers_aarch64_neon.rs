...
//! [`super::myers_scalar`] under a NEON target-feature context. A
//! 128-bit-block Myers using NEON's `vaddq_u64` / `vshlq_u64` primitives
//! is the natural next step and belongs in a standalone commit.

//! Unit-cost Levenshtein edit distance for the StringCheese toolkit.
//!
//! This crate is the first vertical slice of StringCheese's algorithm coverage.
//! Its job is twofold: to provide a correct, workspace-aware Levenshtein
//! implementation, and to exercise every piece of the `stringcheese-core`
...
//! call site, in keeping with StringCheese's rule that a representation choice

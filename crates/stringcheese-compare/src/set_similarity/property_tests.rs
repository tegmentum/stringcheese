...
use crate::ngram::{GramMultiSet, GramSet, GramVector};
use crate::set_similarity::cosine::{Cosine, cosine};
use crate::set_similarity::dice::{DiceOverMultiSet, DiceOverSet, dice_multiset, dice_set};
use crate::set_similarity::jaccard::{
    JaccardOverMultiSet, JaccardOverSet, jaccard_multiset, jaccard_set,
};
use crate::set_similarity::overlap::{Overlap, overlap_set};
...
/// helper used in `stringcheese-jaro`'s property tests.
#[allow(
    clippy::float_cmp,

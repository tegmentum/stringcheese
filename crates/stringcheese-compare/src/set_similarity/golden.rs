...
//!
//! Every case is wired to the `stringcheese-corpus` [`FloatExpectation`]
...
//!
//! [`CharacterGrams`]: crate::ngram::CharacterGrams
//! [`GramSet`]: crate::ngram::GramSet
//! [`GramSet::from_generator`]: crate::ngram::GramSet::from_generator
//! [`GramMultiSet`]: crate::ngram::GramMultiSet
//! [`GramVector`]: crate::ngram::GramVector
//! [`Vec`]: alloc::vec::Vec

use stringcheese_corpus::{FloatExpectation, GoldenCase, GoldenSource};

use crate::set_similarity::cosine::Cosine;
use crate::set_similarity::dice::{DiceOverMultiSet, DiceOverSet};
use crate::set_similarity::jaccard::{JaccardOverMultiSet, JaccardOverSet};
use crate::set_similarity::overlap::Overlap;
...
/// [`crate::ngram::CharacterGrams`] generator through every case. The
...
pub enum SetSimShape {
    ...
    /// gram, deduplicated into a [`crate::ngram::GramSet`].
    Set,
    /// Same character list, but preserved as a multiset with each
    /// character counted separately, stored in a
    /// [`crate::ngram::GramMultiSet<char>`].
    MultiSet,
    /// Same character list, materialized as a
    /// [`crate::ngram::GramVector<char>`] whose per-gram weight is the
    /// count of that character in the list.
    Vector,
    /// The character list is treated as a raw input string, passed through
    /// a character-3-gram generator with [`crate::ngram::PaddingPolicy::None`],
    /// and consumed as a [`crate::ngram::GramSet<Vec<char>>`].
    Chars3Gram,
}
...
mod tests {
    use super::*;
    use crate::ngram::{CharacterGrams, GramMultiSet, GramSet, GramVector, PaddingPolicy};
    use alloc::vec::Vec;
    use stringcheese_core::{AlgorithmDescriptor, SimilarityMetric};

//! Hamming distance for the StringCheese toolkit.
//!
//! This crate is the second vertical slice of StringCheese's algorithm coverage.
//! Where the Levenshtein crate demonstrated that a full dynamic-programming
//! algorithm fits the `stringcheese-core` substrate cleanly, this crate is a
...
//! defined for sequences of different length. StringCheese takes that
...
//!
//! Hamming distance is only defined for equal-length sequences. StringCheese
...
//! [`BoundedDistanceMetric`]: stringcheese_core::BoundedDistanceMetric
//!
//! # Sequence type
//!
...
//! the call site, in keeping with StringCheese's rule that a representation

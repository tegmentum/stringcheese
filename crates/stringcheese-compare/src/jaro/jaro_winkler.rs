...
use crate::jaro::jaro::{jaro_similarity, jaro_similarity_with_workspace};
use crate::jaro::workspace::JaroWorkspace;
...
impl JaroWinkler {
    ...
    /// rationale.
    ///
    /// [`Jaro::similarity_normalized`]: crate::jaro::jaro::Jaro::similarity_normalized
    #[inline]
    #[must_use]

...
//!
//! This crate is the fourth vertical slice of StringCheese's algorithm coverage
...
//! literature and in most third-party libraries. StringCheese distinguishes
...
//!
//! [`BoundedDistance`]: stringcheese_core::BoundedDistance
//!
//! # Semantics
//!
...
//! reachability under the "one edit per substring" restriction. StringCheese's
...
#[cfg(feature = "alloc")]
pub mod algorithm;
// Inner `damerau` submodule (full unrestricted Damerau-Levenshtein) shares
// the enclosing module's name — a load-bearing structural choice that lets
// `crate::damerau::damerau::full_matrix` and its siblings sit next to the
// `crate::damerau::osa::*` sub-tree in the same shape they had when this
// crate lived as its own top-level `stringcheese-damerau` crate.
#[cfg(feature = "alloc")]

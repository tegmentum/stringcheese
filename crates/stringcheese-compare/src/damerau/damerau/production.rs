...
//! ([`crate::damerau::damerau::full_matrix`]), but replaces the oracle's linear scan
...
//! [`crate::damerau::workspace`] for the type-parameter rationale behind why the
...
mod tests {
    use super::*;
    use crate::damerau::damerau::full_matrix::distance_full_matrix;

...
//!
//! StringCheese deliberately avoids returning bare numeric values from
...
impl NormalizedDistance {
    ...
    ///
    /// ```
    /// use stringcheese_core::result::NormalizedDistance;
...
/// the range invariant.
///
/// StringCheese does not automatically convert between [`NormalizedDistance`]
...
impl NormalizedSimilarity {
    ...
    ///
    /// ```
    /// use stringcheese_core::result::NormalizedSimilarity;

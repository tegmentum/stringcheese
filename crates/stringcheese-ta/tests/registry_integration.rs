//! Verifies that depending on `stringcheese-ta` is enough to make the
//! Tamil pack visible through [`stringcheese_lang::registry`]. The
//! `register_language!` macro in `stringcheese-ta/src/lib.rs` is the
...
stringcheese_lang::pack_registry_smoke_test! {
    pack: stringcheese_ta::TAMIL,
    pack_ty: stringcheese_ta::Tamil,
    code: "ta",
    name: "Tamil",
    smoke: |lang| {

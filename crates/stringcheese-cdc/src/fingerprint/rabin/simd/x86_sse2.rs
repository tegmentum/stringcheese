...
//! kernel shape (strictly sequential `GF(2)` shift-and-XOR recurrence,
//! currently shared with the scalar core under `#[target_feature]`
//! scaffolding), the byte-identical contract, and the shared `unsafe`
//! policy.

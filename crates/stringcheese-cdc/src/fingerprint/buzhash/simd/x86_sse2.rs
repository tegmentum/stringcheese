...
//! kernel shape (strictly sequential rotate/xor recurrence, currently
//! shared with the scalar core under `#[target_feature]` scaffolding),
//! the byte-identical contract, and the shared `unsafe` policy.

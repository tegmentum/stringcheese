...
//! kernel shape (Mersenne-61 modular arithmetic, strictly sequential
//! recurrence, currently shared with the scalar core under
//! `#[target_feature]` scaffolding), the byte-identical contract, and
//! the shared `unsafe` policy.

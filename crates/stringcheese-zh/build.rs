...
use stringcheese_scud::{
    ...
    SECT_PERCENT_PATTERN, SECT_PRIMARY_OVERRIDES, SECT_SENTENCE_CLASSES, SECT_SENTENCE_RULES,
    SECT_SIMPLE_FOLD, SECT_SIMPLE_LOWER, SECT_SIMPLE_UPPER, SECT_TIME_PATTERNS, SECT_WEEKDAY_ABBR,

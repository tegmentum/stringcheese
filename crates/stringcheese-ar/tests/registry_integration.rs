//! Verifies that depending on `stringcheese-ar` is enough to make the
//! Arabic pack visible through [`stringcheese_lang::registry`]. The
//! `register_language!` macro in `stringcheese-ar/src/lib.rs` is the
...
stringcheese_lang::pack_registry_smoke_test! {
    pack: stringcheese_ar::ARABIC,
    pack_ty: stringcheese_ar::Arabic,
    code: "ar",
    name: "Arabic",
    smoke: |lang| {

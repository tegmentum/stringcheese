//! Verifies that depending on `stringcheese-th` is enough to make the
//! Thai pack visible through [`stringcheese_lang::registry`]. The
//! `register_language!` macro in `stringcheese-th/src/lib.rs` is the
...
stringcheese_lang::pack_registry_smoke_test! {
    pack: stringcheese_th::THAI,
    pack_ty: stringcheese_th::Thai,
    code: "th",
    name: "Thai",
    smoke: |lang| {

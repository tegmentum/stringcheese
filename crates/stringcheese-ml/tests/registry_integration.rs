//! Verifies that depending on `stringcheese-ml` is enough to make the
//! Malayalam pack visible through [`stringcheese_lang::registry`]. The
//! `register_language!` macro in `stringcheese-ml/src/lib.rs` is the
...
stringcheese_lang::pack_registry_smoke_test! {
    pack: stringcheese_ml::MALAYALAM,
    pack_ty: stringcheese_ml::Malayalam,
    code: "ml",
    name: "Malayalam",
    smoke: |lang| {

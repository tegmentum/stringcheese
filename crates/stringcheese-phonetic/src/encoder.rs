...
//!
//! StringCheese's design document describes a richer phonetic-subsystem API
...
//! * A [`PhoneticEncoder::descriptor`] that pins the variant per StringCheese's
...
//!
//! [reg]: stringcheese_core::AlgorithmDescriptor
...
///
/// Implementations declare themselves as one of StringCheese's known algorithm
...
/// [`stringcheese_core::VariantId`]: it makes language declarations searchable

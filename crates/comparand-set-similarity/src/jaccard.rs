...
//! ```
//!
//! and always lies in `[0.0, 1.0]`. On multisets Comparand uses the
...
//!
//! [`MetricClass::Similarity`]: comparand_core::MetricClass::Similarity
...
use comparand_ngram::{GramMultiSet, GramSet};

...
//! macro — see its docs for the field-level contract. The smoke closure
//! exercises both the Cyrillic and Latin surface forms.
#![cfg(not(target_family = "wasm"))]

stringcheese_lang::pack_registry_smoke_test! {
    pack: stringcheese_sr::SERBIAN,
    pack_ty: stringcheese_sr::Serbian,
    code: "sr",
    name: "Serbian",
    smoke: |lang| {
        // Cyrillic

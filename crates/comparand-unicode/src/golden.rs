...
//! the `GoldenCase<I, O>` shape from `comparand-corpus`
...
//! `comparand-corpus`'s types — that would create a dev-dependency
...
mod tests {
    ...
    // in a Comparand transformation or an update to a dependency

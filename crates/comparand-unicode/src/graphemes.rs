...
//!
//! Before this module, Comparand algorithms could compare over UTF-8
...
///
/// ```
/// # use comparand_unicode::graphemes;
...
///
/// This is the type that finally lets a Comparand distance kernel
/// compare "over graphemes":
///
/// ```
/// # use comparand_unicode::GraphemeSequence;
...
impl<'a> GraphemeSequence<'a> {
    ...
    /// algorithm that consumes `&[&str]` (which most Comparand

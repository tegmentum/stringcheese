...
pub const GOLDEN_OSA_CHARS: &[CharsCase] = &[GoldenCase {
    ...
    expected: Distance::new(1),
    source: GoldenSource::IndependentlyDerived,
    notes: "Diacritic difference at char-slice granularity is one substitution. At byte granularity the answer would be two — exactly the kind of representation choice Comparand refuses to make silently.",

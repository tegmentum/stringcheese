...
//!
//! [`MetricClass::Semimetric`]: comparand_core::MetricClass::Semimetric

use proptest::prelude::*;

use crate::algorithm::{Damerau, Osa};
use crate::damerau::full_matrix::distance_full_matrix as damerau_full_matrix;
use crate::damerau::production::distance_production_with_workspace as damerau_production;
use crate::osa::banded::distance_banded_with_workspace as osa_banded;
use crate::osa::full_matrix::distance_full_matrix as osa_full_matrix;
use crate::osa::rolling_rows::distance_rolling_rows_with_workspace as osa_rolling_rows;
use crate::workspace::{DamerauWorkspace, OsaWorkspace};
use comparand_core::{BoundedDistance, Distance, DistanceMetric};

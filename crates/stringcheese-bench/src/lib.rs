//! Benchmark suite and comparative-reporting harness for the StringCheese
//! toolkit.
//!
//! # Status
//!
...
//!   five existing algorithm crates (`stringcheese-levenshtein`,
//!   `stringcheese-hamming`, `stringcheese-jaro`, `stringcheese-damerau`,
//!   `stringcheese-ngram`). Runs by default with `cargo bench`.

//! Foundational types and traits for the Comparand sequence-comparison toolkit.
//!
//! This crate contains only the substrate that every other Comparand crate
//! builds against. It does not implement any comparison algorithms itself;
//! algorithms live in dedicated crates ([`comparand-search`], [`comparand-cdc`],
...
//!
//! [`comparand-search`]: https://docs.rs/comparand-search
//! [`comparand-cdc`]: https://docs.rs/comparand-cdc

//! Schema, oracles, and generators for StringCheese's golden-case validation
//! corpus.
//!
...
//! consumed by StringCheese's own test suites; because it is a separately
...
//! incrementally under `crates/stringcheese-corpus/data/` as algorithms come
//! online.
//!
//! # Sources
//!
...
//! (see [`FloatExpectation`]). StringCheese rejects the practice of comparing
...
/// StringCheese defect than a disagreement with a `ReferenceImplementation`

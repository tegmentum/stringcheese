...
//! Indonesian pack visible through [`stringcheese_lang::registry`]. The
//! `register_language!` macro in `stringcheese-id/src/lib.rs` is the
...
stringcheese_lang::pack_registry_smoke_test! {
    pack: stringcheese_id::INDONESIAN,
    pack_ty: stringcheese_id::Indonesian,
    code: "id",
    name: "Indonesian",
    smoke: |lang| {
